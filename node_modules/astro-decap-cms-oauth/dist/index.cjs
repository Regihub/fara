(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require("astro/config"), require("node:fs/promises"), require("node:path"), require("node:url"), require("js-yaml")) : typeof define === "function" && define.amd ? define(["astro/config", "node:fs/promises", "node:path", "node:url", "js-yaml"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.AstroDecapCMSOAuth = factory(global.astroConfig, global.fsPromises, global.path, global.node_url, global.yaml));
})(this, (function(config, fsPromises, path, node_url, yaml) {
  "use strict";
